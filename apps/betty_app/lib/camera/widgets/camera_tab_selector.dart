import 'package:betty_app/camera/bloc/camera_bloc.dart';
import 'package:betty_app/camera/bloc/camera_event.dart';
import 'package:flutter/material.dart';
import 'package:flutter_bloc/flutter_bloc.dart';

class CameraTabSelector extends StatelessWidget {
  final int currentPage;

  const CameraTabSelector({super.key, required this.currentPage});
